...
# Plot energy levels
def plot_energy_levels(data_dict, species:str, z=0, max_labels=10):
    ...
    ax.set_title(f'Energy levels of {species}', fontsize=15, fontweight='bold')
...
data = load_energy_levels('Cs', 0)
data_dict = parse_energy_levels(data, 'Cs')
plot_energy_levels(data_dict, 'Cs', 0)
# print(data_dict)
